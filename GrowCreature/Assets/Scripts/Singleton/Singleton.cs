...
namespace Singleton
{
    ...
    public class Singleton<T> : SingletonBase, ISingleton where T : MonoBehaviour, ISingleton
    {
        private static T s_Instance;
        public bool DontDestroyLoad;

        public bool IsSingletonLogsEnabled
        {
            get => m_IsSingletonLogsEnabled;
            set => m_IsSingletonLogsEnabled = value;
        }

        [SerializeField, HideInInspector] private bool m_IsSingletonLogsEnabled = false;
        ...
        private static bool applicationIsQuittingFlag;
        ...
        protected sealed override void Awake()
        {
            if (s_Instance == null)
            {
                ...
                if (DontDestroyLoad) setDontDestroyOnLoad();
